      ...
      <div className="text-white py-4">
        <div className="row">
          ...
          <div className="col-sm">
            ...
            <div className="redes">
              <div className="col-sm">
              <a href="https://www.facebook.com/dacris.co" className="bi-facebook" style={{ color: "#3b5998", fontSize: "40px" }}> </a>              </div>
              <div className="col-sm">
              <a href="https://www.instagram.com/dacris.co/?hl=es-la"><li><img src={insta} alt="instagram" style={{ width: "40px" }} /> </li></a></div>
              <div className="col-sm">
